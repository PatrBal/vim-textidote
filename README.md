...
Ths plugin provides asynchronous integration of TeXtidote both in Vim and Neovim, with highighting of the errors and warnings. It offers also easy and intuitive navigation of the errors, as well as quick fixes by <Tab> completion.
