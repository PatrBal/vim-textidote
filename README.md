...
## Features
 ...
 - A scratch buffer shows up, listing all the errors.  Navigate the error using `[[` and `]]` and hit `<Enter>` on an error in the error scratch buffer to jump to that error.
